package com.qjm3662.cloud_u_pan.Wifip2pDirect.Activity;
...
import com.qjm3662.cloud_u_pan.Wifip2pDirect.Utils;
...
public class WifiDirectMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.wifi_direct_activity_main);
    ...
    private void initEvents() {
        ...
        senddata.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent serviceIntent = new Intent(WifiDirectMainActivity.this,
                ...
                serviceIntent.putExtra(DataTransferService.EXTRAS_GROUP_OWNER_PORT,
                        8888);
                WifiDirectMainActivity.this.startService(serviceIntent);
            }
        });
        ...
        WifiP2pManager.ConnectionInfoListener mInfoListener = new WifiP2pManager.ConnectionInfoListener() {
            ...
            public void onConnectionInfoAvailable(final WifiP2pInfo minfo) {
                ...
                if (info.groupFormed && info.isGroupOwner) {
                    ...
                    mServerTask = new FileServerAsyncTask(WifiDirectMainActivity.this);
                    mServerTask.executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);

                    mDataTask = new DataServerAsyncTask(WifiDirectMainActivity.this, view);
