...
public class LocalFileUploadRecordingAdapter extends BaseAdapter {

    private LayoutInflater inflater;

    public LocalFileUploadRecordingAdapter(Context context) {
    ...
    @Override
    public int getCount() {
        return App.Public_List_Local_File_Upload.size();
    }

    @Override
    public Object getItem(int i) {
        return App.Public_List_Local_File_Upload.get(App.Public_List_Local_File_Upload.size() - 1 - i);
    }
